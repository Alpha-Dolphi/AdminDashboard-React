...
// export const selectPhotosById = (state, { PhotosId }) =>
//   selectPhotoEntities(state)[PhotosId];

export const selectPhotosByAlbumId = (state, albumId) =>
    Object.values(selectPhotoEntities(state)).filter((photo) => photo.albumId === albumId);
